...
from sklearn.metrics import classification_report, roc_curve, roc_auc_score, PrecisionRecallDisplay, precision_recall_curve;
...
#display = PrecisionRecallDisplay.from_predictions(y_test, y_pred_gbm , name="Gradient Boosting Classifier")
#_ = display.ax_.set_title("2-class Precision-Recall curve")

#PrecisionRecallDisplay.from_estimator(gbm, X_test, y_test)
